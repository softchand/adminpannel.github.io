...
<div class="ui pusher">
      <div class="ui container main-content ">
        ...
        <i class="user icon"></i> Add User</a>
        <div class="ui hidden divider"></div>
        <table class="ui celled table centered " id="example">
            <thead>
                <th>Id</th>
                <th>Name</th>
                <th>Email</th>
  ...
  <script type="text/javascript">
    ...
    $(document).on('submit', '#updateUser', function(e) {
      ...
      var trid = $('#trid').val();
      var id = $('#id').val();
      if (city != '' && pro != '' && username != '' && mobile != '' && email != '') {
        $.ajax({
          url: "update_user.php",
          type: "post",
          data: {
          ...
          success: function(data) {
            ...
            if (status == 'true') {
              ...
              var button = '<td><a href="javascript:void();" data-id="' + id + '" class="ui inverted green button" >Edit</a>  <a href="#!"  data-id="' + id + '"  class="btn btn-danger btn-sm deleteBtn">Delete</a></td>';
              var row = table.row("[id='" + trid + "']");
              row.row("[id='" + trid + "']").data([id, username, email, mobile, pro, city, button]);
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="updateUser">
            ...
            <div class="mb-3 row">
              <label for="proField" class="col-md-3 form-label">Projects Complete</label>
              <div class="col-md-9">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="addUser" action="">
            ...
            <div class="mb-3 row">
              <label for="addProField" class="col-md-3 form-label">Projects Complete</label>
              <div class="col-md-9">
