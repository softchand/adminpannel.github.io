            ...
            <div class="ui fluid card">
              <div class="content">
                ...
                <div class="description">
                 Total Number Of Administrators Completing Projects
                </div>
              </div>
              ...
              <div class="content">
                ...
                <div class="header">
                  <div class="ui header green">
                    <?php 
                    $total_project = mysqli_query($con, "SELECT sum(pro) FROM `adminusers`") or die(mysqli_error());
                ...
                <div class="description">
                  All Administrators are Completed Total Number Of Projests.
                </div>
              </div>
              <div class="extra content">
                <div class="ui two buttons">
          ...
          >
            <div class="ui fluid card">
              <div class="content">
                ...
                <div class="description">
                Administrators Aware Total Number Of Project Skill Categories.</div>
              </div>
              <div class="extra content">
                <div class="ui two buttons">
            ...
            <table class="ui celled red table">
              <thead>
                <tr class="ui celled red">
                  ...
                  Administrators Personal Details Records According to Projects
                  </th>
                </tr>
                <tr>
